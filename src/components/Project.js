const Project = ({ heading }) => {
  return (
    <article className="project">
      <h3>{heading}</h3>
      <p>
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Reiciendis, reprehenderit? Alias quam autem,
        quisquam aspernatur ab iusto aliquid consequuntur veniam at quod placeat asperiores laboriosam!
      </p>
